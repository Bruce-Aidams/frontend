...
function NewOrderPage() {
    ...
    const filteredBundles = bundles.filter((b)=>!selectedNetwork || b.network.toLowerCase().includes(selectedNetwork.toLowerCase()));
    const handleSubmit = async (e)=>{
        ...
        if (!selectedBundle || !phone) {
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please select a bundle and enter a phone number.");
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c65872cc._.js.map