...
"[project]/Desktop/Projects/Megaai/frontend/src/app/not-found.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotFound() {
    ...
    if ($[0] !== "bf57bb650746fe3345fe23dc518b441c4b4cbc5cc2e86028b7dad26f1b52b4cd") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bf57bb650746fe3345fe23dc518b441c4b4cbc5cc2e86028b7dad26f1b52b4cd";
    }
    ...
    if ($[15] !== router) {
        t14 = ({
            "NotFound[<Button>.onClick]": ()=>router.back()
        })["NotFound[<Button>.onClick]"];
        $[15] = router;
        $[16] = t14;
    } else {
        t14 = $[16];
...
//# sourceMappingURL=Desktop_Projects_Megaai_frontend_src_b8c49cd4._.js.map