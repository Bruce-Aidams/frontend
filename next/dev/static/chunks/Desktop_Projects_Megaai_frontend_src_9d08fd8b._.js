...
function AdminOrdersPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(20);
    if ($[0] !== "04fd11a51c30bdd88d6b8f53419c0269ecfea17fb8bb3058a73456c0a96e527b") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "04fd11a51c30bdd88d6b8f53419c0269ecfea17fb8bb3058a73456c0a96e527b";
    }
    let t0;
    ...
    if ($[2] !== filter) {
        t1 = ({
            "AdminOrdersPage[fetchOrders]": async ()=>{
        ...
        })["AdminOrdersPage[fetchOrders]"];
        $[2] = filter;
        $[3] = t1;
    } else {
        t1 = $[3];
    }
    const fetchOrders = t1;
    let t2;
    let t3;
    if ($[4] !== fetchOrders) {
        t2 = ({
            "AdminOrdersPage[useEffect()]": ()=>{
                Promise.resolve().then({
                    "AdminOrdersPage[useEffect() > (anonymous)()]": ()=>fetchOrders()
                }["AdminOrdersPage[useEffect() > (anonymous)()]"]);
            }
        })["AdminOrdersPage[useEffect()]"];
        t3 = [
            fetchOrders
    ...
    if ($[7] !== fetchOrders) {
        t4 = ({
            "AdminOrdersPage[updateStatus]": async (id, status)=>{
                ;
                try {
        ...
        })["AdminOrdersPage[updateStatus]"];
        $[7] = fetchOrders;
        $[8] = t4;
    } else {
        t4 = $[8];
    }
    const updateStatus = t4;
    let t5;
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
    ...
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
            className: "bg-gray-50 uppercase text-gray-500",
    ...
    let t9;
    if ($[13] !== orders || $[14] !== updateStatus) {
        let t10;
        if ($[16] !== updateStatus) {
            t10 = ({
                "AdminOrdersPage[orders.map()]": (order)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                        children: [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            variant: "outline",
                                            onClick: {
                                                "AdminOrdersPage[orders.map() > <Button>.onClick]": ()=>updateStatus(order.id, "completed")
                                            }["AdminOrdersPage[orders.map() > <Button>.onClick]"],
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            variant: "destructive",
                                            onClick: {
                                                "AdminOrdersPage[orders.map() > <Button>.onClick]": ()=>updateStatus(order.id, "failed")
                                            }["AdminOrdersPage[orders.map() > <Button>.onClick]"],
                                            children: "Fail"
                                        }, void 0, false, {
                                            fileName: "[project]/Desktop/Projects/Megaai/frontend/src/app/admin/orders/page.tsx",
...
_s(AdminOrdersPage, "99kICUkWuZU6/AXUdJlsrRh8P7k=");
_c = AdminOrdersPage;
var _c;
...
//# sourceMappingURL=Desktop_Projects_Megaai_frontend_src_9d08fd8b._.js.map