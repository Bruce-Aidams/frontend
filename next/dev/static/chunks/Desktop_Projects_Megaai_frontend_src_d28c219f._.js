...
function OrdersPage() {
    ...
    if ($[0] !== "1d6dec4a9fbb030b4062f12c353e0ada8c9b32d390cd14f5d4cac684a0883377") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1d6dec4a9fbb030b4062f12c353e0ada8c9b32d390cd14f5d4cac684a0883377";
    }
    let t0;
        ...
        t1 = ({
            "OrdersPage[useEffect()]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/orders").then({
                    "OrdersPage[useEffect() > (anonymous)()]": (res)=>{
                        setOrders(res.data.data);
                        setLoading(false);
                    }
                }["OrdersPage[useEffect() > (anonymous)()]"]);
            }
        })["OrdersPage[useEffect()]"];
        t2 = [];
        $[2] = t1;
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
    ...
    let t6;
    if ($[7] !== loading || $[8] !== orders) {
        t6 = loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            ...
            lineNumber: 82,
            columnNumber: 20
        }, this) : orders.map(_OrdersPageOrdersMap);
        $[7] = loading;
        $[8] = orders;
        $[9] = t6;
    } else {
...
_s(OrdersPage, "cqffJ65utMOB/xp3jw2Bujg0spA=");
_c = OrdersPage;
function _OrdersPageOrdersMap(order) {
...
//# sourceMappingURL=Desktop_Projects_Megaai_frontend_src_d28c219f._.js.map