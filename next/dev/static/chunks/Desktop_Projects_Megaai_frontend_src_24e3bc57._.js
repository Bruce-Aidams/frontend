...
"[project]/Desktop/Projects/Megaai/frontend/src/lib/phoneValidation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * Supports formats: 0XX XXX XXXX and 233XX XXX XXXX
...
function validateGhanaPhone(phone) {
    ...
    // Check if it starts with 233 (country code)
    if (cleaned.startsWith('233')) {
        ...
        if (!GHANA_PREFIXES.includes(prefix)) {
            return {
                isValid: false,
                formatted: phone,
                error: `Invalid network prefix. Must start with ${GHANA_PREFIXES.join(', ')}`
            };
        }
        return {
            isValid: true,
            formatted: `0${localNumber}` // Return in local format
        };
    }
    ...
    // If doesn't start with 0 or 233
    return {
        isValid: false,
        formatted: phone,
        error: 'Phone number must start with 0 or 233'
    };
}
...
function getNetworkFromPhone(phone) {
    ...
    if ([
        ...
        '027',
        '057'
    ].includes(prefix)) return 'MTN';
    if ([
        '026',
        '056'
    ].includes(prefix)) return 'AirtelTigo';
    if ([
        '020',
        '050'
    ].includes(prefix)) return 'Vodafone';
    if (prefix === '059') return 'Glo';
    return 'Unknown';
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$phoneValidation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Projects/Megaai/frontend/src/lib/phoneValidation.ts [app-client] (ecmascript)");
;
...
function NewOrderPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(163);
    if ($[0] !== "e93dd427538f0303d0298e1f9c8d0f979293a5c1c95aa95ca680d17d8f6b10b8") {
        for(let $i = 0; $i < 163; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e93dd427538f0303d0298e1f9c8d0f979293a5c1c95aa95ca680d17d8f6b10b8";
    }
    let t0;
    ...
    const [bundles, setBundles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    const [selectedNetwork, setSelectedNetwork] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [, setPhoneError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [isPhoneValid, setIsPhoneValid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { addToCart, cartItems } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    let t1;
    ...
    const networks = t1;
    const getNetworkPrefixes = _NewOrderPageGetNetworkPrefixes;
    let t2;
    let t3;
        ...
        t2 = ({
            "NewOrderPage[useEffect()]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/products").then({
                    "NewOrderPage[useEffect() > (anonymous)()]": (res)=>setBundles(res.data)
                }["NewOrderPage[useEffect() > (anonymous)()]"]);
            }
        })["NewOrderPage[useEffect()]"];
        t3 = [];
        $[3] = t2;
    ...
    let t8;
    let t9;
    if ($[5] !== addToCart || $[6] !== bundles || $[7] !== cartItems.length || $[8] !== isPhoneValid || $[9] !== phone || $[10] !== selectedBundle || $[11] !== selectedNetwork) {
        let t24;
        if ($[39] !== selectedNetwork) {
            t24 = ({
                "NewOrderPage[bundles.filter()]": (b)=>!selectedNetwork || b.network.toLowerCase().includes(selectedNetwork.toLowerCase())
            })["NewOrderPage[bundles.filter()]"];
            $[39] = selectedNetwork;
            $[40] = t24;
        } else {
            t24 = $[40];
        }
        filteredBundles = bundles.filter(t24);
        let t25;
        if ($[41] !== addToCart || $[42] !== bundles || $[43] !== isPhoneValid || $[44] !== phone || $[45] !== selectedBundle || $[46] !== selectedNetwork) {
            t25 = ({
                "NewOrderPage[handleSubmit]": async (e)=>{
                    e.preventDefault();
                    if (!selectedNetwork) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please select a network first.");
                        return;
                    }
                    if (!selectedBundle || !phone) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please select a bundle and enter a phone number.");
                        return;
                    }
                    if (!isPhoneValid) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please enter a valid Ghana phone number.");
                        return;
                    }
                    const bundle = bundles.find({
                        "NewOrderPage[handleSubmit > bundles.find()]": (b_0)=>String(b_0.id) === selectedBundle
                    }["NewOrderPage[handleSubmit > bundles.find()]"]);
                    if (!bundle) {
                        return;
                    }
                    const validation_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$phoneValidation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateGhanaPhone"])(phone);
                    addToCart({
                        bundle_id: bundle.id,
                        bundle_name: bundle.name,
                        network: bundle.network,
                        price: bundle.price,
                        recipient_phone: validation_0.formatted
                    });
                    __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Added to cart!");
                    setPhone("");
                    setPhoneError("");
                    setIsPhoneValid(false);
                    setSelectedBundle("");
                }
            })["NewOrderPage[handleSubmit]"];
            $[41] = addToCart;
            $[42] = bundles;
            $[43] = isPhoneValid;
            $[44] = phone;
        ...
        const handleSubmit = t25;
        let t26;
        if ($[48] !== bundles || $[49] !== selectedBundle) {
            let t27;
            if ($[51] !== selectedBundle) {
                t27 = ({
                    "NewOrderPage[bundles.find()]": (b_1)=>String(b_1.id) === selectedBundle
                })["NewOrderPage[bundles.find()]"];
                $[51] = selectedBundle;
                $[52] = t27;
            } else {
                t27 = $[52];
            }
            t26 = bundles.find(t27);
            $[48] = bundles;
            $[49] = selectedBundle;
            $[50] = t26;
        } else {
        ...
        selectedBundleData = t26;
        T4 = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div;
        ...
        t22 = "max-w-4xl mx-auto space-y-6";
        let t27;
        ...
        let t28;
        if ($[57] !== cartItems.length) {
            t28 = cartItems.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                asChild: true,
                variant: "outline",
        ...
        t18 = "grid gap-6 md:grid-cols-5";
        t17 = "md:col-span-3";
        T3 = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"];
        t15 = "sneat-card border-none shadow-sm h-full";
        ...
        T2 = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"];
        t12 = handleSubmit;
        t13 = "space-y-6";
        let t29;
        if ($[62] === Symbol.for("react.memo_cache_sentinel")) {
            t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: networks.map({
                            "NewOrderPage[networks.map()]": (net)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: {
                                        "NewOrderPage[networks.map() > <button>.onClick]": ()=>{
                                            setSelectedNetwork(net);
                                            setSelectedBundle("");
                                        }
                                    }["NewOrderPage[networks.map() > <button>.onClick]"],
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("py-3 px-2 rounded-xl border-2 transition-all flex flex-col items-center gap-1", selectedNetwork === net ? "border-primary bg-primary/5 text-primary" : "border-gray-100 bg-gray-50 text-muted-foreground hover:border-gray-200"),
        ...
        const t30 = !selectedNetwork && "opacity-50 pointer-events-none";
        if ($[65] !== t30) {
            t10 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("space-y-2 transition-all duration-300", t30);
            $[65] = t30;
            $[66] = t10;
        } else {
            t10 = $[66];
        ...
        if ($[67] === Symbol.for("react.memo_cache_sentinel")) {
            t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                className: "text-sm font-semibold flex items-center gap-2 text-gray-700",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-6 h-6 bg-gray-100 rounded-md flex items-center justify-center text-[10px] font-bold",
        ...
        T1 = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"];
        t6 = selectedBundle;
        t7 = setSelectedBundle;
        t8 = !selectedNetwork;
        const t31 = selectedNetwork ? `Choose an ${selectedNetwork} package...` : "Select a network first";
        if ($[68] !== t31) {
        ...
        T0 = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"];
        t4 = "rounded-xl border-gray-100 shadow-xl";
        t5 = filteredBundles.map(_NewOrderPageFilteredBundlesMap);
        $[5] = addToCart;
        $[6] = bundles;
        $[7] = cartItems.length;
        $[8] = isPhoneValid;
    ...
    let t24;
    if ($[70] !== filteredBundles.length || $[71] !== selectedNetwork) {
        t24 = filteredBundles.length === 0 && selectedNetwork && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t25;
    if ($[73] !== T0 || $[74] !== t24 || $[75] !== t4 || $[76] !== t5) {
        t25 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(T0, {
            className: t4,
            children: [
                t5,
                t24
    ...
    let t26;
    if ($[78] !== T1 || $[79] !== t25 || $[80] !== t6 || $[81] !== t7 || $[82] !== t8 || $[83] !== t9) {
        t26 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(T1, {
            value: t6,
            onValueChange: t7,
            disabled: t8,
            children: [
    ...
    const t28 = !selectedBundle && "opacity-50 pointer-events-none";
    let t29;
    if ($[89] !== t28) {
        t29 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("space-y-2 transition-all duration-300", t28);
        $[89] = t28;
        $[90] = t29;
    } else {
        t29 = $[90];
    ...
    if ($[91] === Symbol.for("react.memo_cache_sentinel")) {
        t30 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
            className: "text-sm font-semibold flex items-center gap-2 text-gray-700",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-6 h-6 bg-gray-100 rounded-md flex items-center justify-center text-[10px] font-bold",
    ...
    if ($[92] === Symbol.for("react.memo_cache_sentinel")) {
        t31 = ({
            "NewOrderPage[<Input>.onChange]": (e_0)=>setPhone(e_0.target.value)
        })["NewOrderPage[<Input>.onChange]"];
        $[92] = t31;
    } else {
        t31 = $[92];
    }
    const t32 = !selectedBundle;
    let t33;
    if ($[93] !== phone || $[94] !== t32) {
    ...
    let t35;
    if ($[97] !== t33) {
        t35 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "relative",
            children: [
                t33,
                t34
    ...
    let t36;
    if ($[99] !== selectedNetwork) {
        t36 = selectedNetwork && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    let t37;
    if ($[101] !== t29 || $[102] !== t35 || $[103] !== t36) {
        t37 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: t29,
            children: [
                t30,
                t35,
    ...
    const t38 = !selectedBundle || !phone;
    let t39;
    ...
    let t41;
    if ($[108] !== t12 || $[109] !== t13 || $[110] !== t14 || $[111] !== t27 || $[112] !== t37 || $[113] !== t40) {
        t41 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            onSubmit: t12,
            className: t13,
            children: [
                t14,
    ...
    let t42;
    if ($[115] !== T2 || $[116] !== t41) {
        t42 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(T2, {
            children: t41
        }, void 0, false, {
            fileName: "[project]/Desktop/Projects/Megaai/frontend/src/app/dashboard/orders/new/page.tsx",
            lineNumber: 499,
    ...
    let t43;
    if ($[118] !== T3 || $[119] !== t15 || $[120] !== t16 || $[121] !== t42) {
        t43 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(T3, {
            className: t15,
            children: [
                t16,
                t42
    ...
    if ($[126] === Symbol.for("react.memo_cache_sentinel")) {
        t45 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if ($[128] === Symbol.for("react.memo_cache_sentinel")) {
        t47 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const t48 = selectedNetwork || "---";
    let t49;
    if ($[129] !== t48) {
        t49 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if ($[131] === Symbol.for("react.memo_cache_sentinel")) {
        t50 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-xs opacity-70",
            children: "Service"
        }, void 0, false, {
            fileName: "[project]/Desktop/Projects/Megaai/frontend/src/app/dashboard/orders/new/page.tsx",
    ...
    const t51 = selectedBundleData?.name || "---";
    let t52;
    if ($[132] !== t51) {
        t52 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex justify-between items-center py-2 border-b border-white/20",
            children: [
                t50,
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    if ($[134] === Symbol.for("react.memo_cache_sentinel")) {
        t53 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-xs opacity-70",
    ...
    if ($[137] === Symbol.for("react.memo_cache_sentinel")) {
        t56 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t57;
    if ($[138] !== selectedBundleData) {
        t57 = selectedBundleData?.price ? Number(selectedBundleData.price).toFixed(2) : "0.00";
        $[138] = selectedBundleData;
        $[139] = t57;
    } else {
        t57 = $[139];
    }
    let t58;
    if ($[140] !== t57) {
        t58 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t59;
    if ($[142] !== t49 || $[143] !== t52 || $[144] !== t55 || $[145] !== t58) {
        t59 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
    ...
    if ($[147] === Symbol.for("react.memo_cache_sentinel")) {
        t60 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if ($[148] === Symbol.for("react.memo_cache_sentinel")) {
        t61 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
    ...
    let t62;
    if ($[149] !== t59) {
        t62 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t63;
    if ($[151] !== t18 || $[152] !== t44 || $[153] !== t62) {
        t63 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: t18,
            children: [
                t44,
                t62
    ...
    let t64;
    if ($[155] !== T4 || $[156] !== t19 || $[157] !== t20 || $[158] !== t21 || $[159] !== t22 || $[160] !== t23 || $[161] !== t63) {
        t64 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(T4, {
            initial: t19,
            animate: t20,
            transition: t21,
            className: t22,
...
_s(NewOrderPage, "1QuEqs3HgxRi9ACiIMAywyhvYpI=", false, function() {
    return [
...
_c = NewOrderPage;
function _NewOrderPageFilteredBundlesMap(bundle_0) {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$Megaai$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    children: [
                        "GHS ",
                        Number(bundle_0.price).toFixed(2)
                    ]
                }, void 0, true, {
                    fileName: "[project]/Desktop/Projects/Megaai/frontend/src/app/dashboard/orders/new/page.tsx",
                    lineNumber: 671,
...
function _NewOrderPageGetNetworkPrefixes(network) {
    switch(network){
        case "MTN":
            {
...
//# sourceMappingURL=Desktop_Projects_Megaai_frontend_src_24e3bc57._.js.map