...
function AdminDepositsPage() {
    ...
    const filteredDeposits = deposits.filter((d)=>d.user.name.toLowerCase().includes(searchTerm.toLowerCase()) || d.user.email.toLowerCase().includes(searchTerm.toLowerCase()) || d.amount.includes(searchTerm));
...
//# sourceMappingURL=Desktop_Projects_Megaai_frontend_src_d9d3c872._.js.map